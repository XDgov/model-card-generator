...
class ModelCardGenerator(cmd.Cmd):
    ...
    statements_dict = {
        ...
        'Inaccurate Data Identification & Mitigation': ['Inclusion of information related to individuals or human populations in the training/testing/validation datasets - Yes/No, if "yes" include a description of demographic features', 'Methods used to minimize imprecise data from human judgement', 'Potentially inaccurate data found in the training dataset from collection methods, sample size, representation, etc.', 'Testing/evaluation performed to look for inaccurate data in the workflow of the model', 'Degree of model explainability/transparency'],
